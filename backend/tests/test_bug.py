...
# Score the plain text
original_score = ats_scorer.score(resume_text, jd)
print("--- ORIGINAL SCORE ---")
print(json.dumps(original_score, indent=2))
...
# Score the parsed JSON string
rewritten_text = json.dumps(parsed)
json_score = ats_scorer.score(rewritten_text, jd)
print("\n--- JSON SCORE ---")
